...
- El guardado fiscal desde validación usa `PATCH /facturacion/:idFol/cliente-fiscal` bajo gestión `FACTURA`; mantenimiento general continúa con alcance propio en `/factclientshp`.
