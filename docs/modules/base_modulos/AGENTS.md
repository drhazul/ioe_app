...
- Facturación edición fiscal por folio (2026-07-30): el diálogo de validación envía payload fiscal a `PATCH /facturacion/:idFol/cliente-fiscal`; no usa el endpoint de mantenimiento `PATCH /factclientshp/:id`.
