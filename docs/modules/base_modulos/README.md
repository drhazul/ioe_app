...
- Facturación edición fiscal por folio (2026-07-30): el diálogo de validación guarda mediante `PATCH /facturacion/:idFol/cliente-fiscal`, manteniendo separado el alcance de mantenimiento de clientes.
