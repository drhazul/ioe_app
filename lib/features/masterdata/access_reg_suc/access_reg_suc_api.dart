...
class AccessRegSucApi {
  ...
  Future<List<AccessRegSucModel>> fetchAll({
    String? modulo,
    String? usuario,
    String? suc,
    bool? activo,
    ...
    if (sucUsuario != null && sucUsuario.trim().isNotEmpty) {
      query['sucUsuario'] = sucUsuario.trim();
    }
    if (depto != null && depto.trim().isNotEmpty) query['depto'] = depto.trim();
    ...
    return (res.data as List<dynamic>)
        .map(
          (e) =>
              AccessRegSucModel.fromJson(Map<String, dynamic>.from(e as Map)),
        )
        .toList();
  }

  Future<AccessRegSucModel> fetchOne(
    String modulo,
    String usuario,
    String suc,
  ) async {
    final res = await dio.get(_keyPath(modulo, usuario, suc));
    return AccessRegSucModel.fromJson(
  ...
  Future<AccessRegSucModel> update(
    String modulo,
    String usuario,
    String suc,
